...
class EditField extends StatefulWidget {
  ...
  const EditField({super.key, required this.initialText, required this.onConfirmation, required this.styleMap, this.preventTextEditing = false});

  @override
  EditFieldState createState() => EditFieldState();
}

class EditFieldState extends State<EditField> {
