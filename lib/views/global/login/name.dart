...
class _NameFormPageState extends State<NameFormPage> {
  ...
  Widget build(BuildContext context) {
    Future<void> signIn() async {
      ...
      context.read<UsersController>().updateOnboardingFirstName(firstnameController.text);
      context.read<UsersController>().updateOnboardingLastName(lastnameController.text);
