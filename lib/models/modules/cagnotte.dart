...
class CagnotteModule extends Module {
  String cagnotteUrl;
  ...
  CagnotteModule({
    ...
    required this.cagnotteUrl,
  });

  static CagnotteModule fromMap(String id, Map<String, dynamic> json) {
    DateTime parsedDate;
