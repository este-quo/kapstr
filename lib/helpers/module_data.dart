...
Map<String, dynamic> invitationCardModule(String womanFirstName, String manFirstName, String introduction, String conclusion, String eventType) {
  return {
    ...
    'title': womanFirstName == '' ? capitalize(manFirstName) : "${capitalize(manFirstName)} & ${capitalize(womanFirstName)}",
    ...
    'names': womanFirstName == '' ? capitalize(manFirstName) : "${capitalize(manFirstName)} & ${capitalize(womanFirstName)}",
