...
class ColumnDisposition extends StatefulWidget {
  final List<Module> modules;
  final Function callback;

  const ColumnDisposition({super.key, required this.modules, required this.callback});

  @override
  State<ColumnDisposition> createState() => _ColumnDispositionState();
}

class _ColumnDispositionState extends State<ColumnDisposition> {
  @override
  void initState() {
    super.initState();
    _sortModules();
  ...
  @override
  void didUpdateWidget(covariant ColumnDisposition oldWidget) {
