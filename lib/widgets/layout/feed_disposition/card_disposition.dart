...
class CardDisposition extends StatefulWidget {
  final List<Module> modules;
  final Function callback;

  const CardDisposition({super.key, required this.modules, required this.callback});

  @override
  State<CardDisposition> createState() => _CardDispositionState();
}

class _CardDispositionState extends State<CardDisposition> {
  @override
  void initState() {
    super.initState();
    _sortModules();
  ...
  @override
  void didUpdateWidget(covariant CardDisposition oldWidget) {
